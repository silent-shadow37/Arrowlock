...
function arrowSvg(dir,variant){
  const shapes={
    right:[
      'M 6 50 H 94',
      'M 6 70 H 42 V 28 H 72 V 50 H 94',
      'M 6 24 H 38 V 76 H 63 V 42 H 94',
      'M 6 52 H 30 V 24 H 58 V 72 H 94',
      'M 6 76 H 25 V 44 H 50 V 20 H 76 V 50 H 94'
    ],
    left:[
      'M 94 50 H 6',
      'M 94 70 H 58 V 28 H 28 V 50 H 6',
      'M 94 24 H 62 V 76 H 37 V 42 H 6',
      'M 94 52 H 70 V 24 H 42 V 72 H 6',
      'M 94 76 H 75 V 44 H 50 V 20 H 24 V 50 H 6'
    ],
    down:[
      'M 50 6 V 94',
      'M 30 6 V 42 H 72 V 70 H 50 V 94',
      'M 76 6 V 38 H 24 V 63 H 58 V 94',
      'M 48 6 V 30 H 76 V 58 H 28 V 94',
      'M 24 6 V 25 H 56 V 50 H 80 V 76 H 50 V 94'
    ],
    up:[
      'M 50 94 V 6',
      'M 30 94 V 58 H 72 V 30 H 50 V 6',
      'M 76 94 V 62 H 24 V 37 H 58 V 6',
      'M 48 94 V 70 H 76 V 42 H 28 V 6',
      'M 24 94 V 75 H 56 V 50 H 80 V 24 H 50 V 6'
    ]
  };
  const d=shapes[dir][variant%shapes[dir].length];
  const end = dir==='right'?[94,50] : dir==='left'?[6,50] : dir==='down'?[50,94] : [50,6];
  const points = dir==='right' ? `${end[0]},${end[1]} 84,43 84,57` :
    dir==='left' ? `${end[0]},${end[1]} 16,43 16,57` :
    dir==='down' ? `${end[0]},${end[1]} 43,84 57,84` : `${end[0]},${end[1]} 43,16 57,16`;
  return `<svg viewBox="0 0 100 100" aria-hidden="true"><path d="${d}" fill="none" stroke="#343848" stroke-width="4.2" stroke-linecap="round" stroke-linejoin="round"/><polygon points="${points}" fill="#343848"/></svg>`;
}
